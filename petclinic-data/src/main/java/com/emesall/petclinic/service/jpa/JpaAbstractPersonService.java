...
@Profile("jpa")
public abstract class JpaAbstractPersonService<T extends Person> extends JpaAbstractClassService<T, PersonRepository<T>, Long>
		implements PersonService<T>,UserDetailsService {
